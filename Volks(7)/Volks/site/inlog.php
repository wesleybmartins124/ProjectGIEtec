            ...
            <div class="rd-navbar-main">
              ...
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                  <li class="rd-nav-item active"><a class="rd-nav-link" href="inlog.php">Home</a>
                  </li>
                </ul>
                <div class="rd-navbar-tel">
                  <p>RAMAL - Geração de Ideias</p><a href="tel:#">70-5182/5183</a>
                </div>
                <a class="button button-sm button-default-outline button-winona" href="sair.php"><div class="content-original">Sair</div><div class="content-dubbed">Sair</div></a>
          </nav>
        </div>
      </header>
      <!-- FScreen-->
        ...
        <div class="layout-4-item-right">
          <div class="box-custom-2 bg-accent">
            ...
            <div class="box-custom-2-inner">
              ...
              <h4 class="text-default wow fadeIn" data-wow-delay=".2s">Seja bem vindo(a) a plataforma Geração de Ideias</h4>
            </div>
          </div>
        </div>
        <div class="layout-4-item-left"><img src="images/photo-16.jpg" alt="" width="654" height="515"/>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row row-50 justify-content-center justify-content-xl-between align-items-center">
            <div class="col-sm-10 col-lg-5">
              <h3>Que tal essa ideia ?</h3>
              <!-- Bootstrap tabs-->
              <div class="tabs-custom tabs-horizontal tabs-line tabs-line_1 block-8" id="tabs-1">
                <!-- Nav tabs-->
                <ul class="nav nav-tabs">
                  <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-1" data-toggle="tab"><span>Proponha uma ideia</span></a></li>
                </ul>
                <!-- Tab panes-->
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="tabs-1-1">
                    <p class="big">Após analisar o cenário de sua área, venha propor resultados produtivos e obtenha ganhos. Clique no botão abaixo!</p>
                    <a class="button button-default button-winona" href="idea.php">Propor ideia</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-sm-10 col-lg-7 wow fadeIn text-center" data-wow-delay=".2s"><img src="images/bright.jpg" alt="" width="450" height="390"/>
            </div>
          </div>
        </div>
      </section>
